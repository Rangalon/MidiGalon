...
namespace MidiGalon.MidiInput
{
    ...
    public class WinMMMidiAccess
    {
        public IEnumerable<WinMMPortDetails> Inputs
        {
            get
            {
        ...
        public IEnumerable<WinMMPortDetails> Outputs
        {
            get
            {
        ...
        public Task<WinMMMidiInput> OpenInputAsync(string portId)
        {
            WinMMPortDetails details = Inputs.FirstOrDefault(d => d.Id == portId);
            if (details == null)
                throw new InvalidOperationException($"The device with ID {portId} is not found.");
            return Task.FromResult((WinMMMidiInput)new WinMMMidiInput(details));
        }
    ...
    {
        public WinMMPortDetails Port { get; private set; }
    }


    public class WinMMPortDetails
    {
    ...
    public class WinMMMidiInput
    {
        ...
        public WinMMMidiInput(WinMMPortDetails details)
        {
        ...
        public WinMMPortDetails Details { get; private set; }
