...
namespace MidiGalon
{
    public sealed class SetTempoEvent : MetaEvent
    {
        ...
        public long MicrosecondsPerQuarterNote
        {
            ...
            set
            {
                //ThrowIfArgument.IsOutOfRange(                    nameof(value),                    value,                    MinMicrosecondsPerQuarterNote,                    MaxMicrosecondsPerQuarterNote,                    $"Number of microseconds per quarter note is out of [{MinMicrosecondsPerQuarterNote}; {MaxMicrosecondsPerQuarterNote}] range.");
