...
namespace MidiGalon
{
    public sealed class MidiTimeCodeEvent : SystemCommonEvent
    {
            ...
            : this()
        {
            ...
            //ThrowIfArgument.IsGreaterThan(nameof(componentValue),                                          componentValue,                                          maximumComponentValue,                                          $"Component's value is greater than maximum valid one which is {maximumComponentValue}.");
